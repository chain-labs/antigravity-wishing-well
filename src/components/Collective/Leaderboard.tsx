...
export default function Leaderboard({
	...
	return (
		<div ref={targetRef}>
			<motion.div
				className="relative w-full max-w-[1200px] border-t-4 border-b-4 md:border-4  mt-[30px] bg-clip-padding border-transparent p-[16px] md:p-[32px] bg-agblack md:rounded-xl z-0
