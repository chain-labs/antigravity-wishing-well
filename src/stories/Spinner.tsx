...
import DynamicNumberCounter from "@/app/model/components/spinner/DynamicNumberCounter";
import AutomaticIncreamentalNumberCounter from "@/app/model/components/spinner/AutomaticIncreamentalNumberCounter";
...
type SpinnerProps = {
	...
	/*
	 * Stage of the spinner
	 */
	stage: 1 | 2 | 3;
	/*
	 * Bonus of the spinner
	 */
	bonus: number;
	/*
	 * Days left
