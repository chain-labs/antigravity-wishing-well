...
const Register = ({ isRegistered, handleRegister, isSuccess, handleSuccess }: RegisterProps) => {
    ...
    return (
        <div className='flex'>
            ...
            {!isRegistered && !isSuccess ? <div className="w-full lg:w-1/2 absolute bottom-10 lg:bottom-20 lg:left-24">
                <div className="flex flex-col items-center lg:items-start">
                    <p className="font-black font-sans text-6xl lg:text-8xl text-white text-center lg:text-left">
                        Join the revolution!
                    </p>
                    <p className="font-normal font-sans text-lg lg:text-xl text-white text-center lg:text-left mt-2 lg:mt-4">
                        Do you wish there was a project that could help the people take back economic power of crypto from banks and governments? Contribute now and freely mine, claim, mint, unwrap, and scrape crypto.
                    </p>
                    <div className="flex flex-col lg:flex-row mt-3 lg:mt-5">
                        <button onClick={handleRegister} className="flex items-center justify-center font-sans font-extrabold rounded-lg bg-blue px-5 py-2 lg:px-6 lg:py-4 mb-2 lg:mb-0 lg:mr-4">
                            <img src="wallet.svg" className="w-6 h-6 lg:w-8 lg:h-8 mr-2" alt="wallet_icon" /> CONNECT WALLET
                        </button>
                        <button className="flex items-center justify-center font-sans font-extrabold rounded-lg bg-gray-800 px-5 py-2 lg:px-6 lg:py-4">
                            <img src="info.svg" className="w-6 h-6 lg:w-8 lg:h-8 mr-2" alt="info_icon" /> LEARN MORE
                        </button>
                    </div>
                ...
                : isSuccess ? <div className="absolute w-full flex items-center flex-col mt-72">
                    ...
                    <div className="bg-gray-800 text-white bg-gradient-to-r from-brblue via-brred p-1 my-4 ml-4">
                        <div className="bg-agblack w-[272px] flex flex-col items-center p-4">
                            ...
                            <div className="p-4 mb-2 flex flex-col items-start bg-bgblue w-full m-4">
                                ...
                                <p className="text-3xl font-sans font-blank">
                                    0.4151 ETH
                                </p>
                    ...
                    <p className="font-sans text-xl font- mt-4">
                        Contribute now on Ethereum or Pulse chain to either of our addresses below.
                    </p>
                    <div className="flex lg:flex-row mt-3 lg:mt-5">
                        <button onClick={handleSuccess} className="flex items-center justify-center font-sans font-extrabold rounded-lg bg-blue px-5 py-2 lg:px-6 lg:py-4 mb-2 lg:mb-0 lg:mr-4">
