...
const Header: React.FC = () => {
  ...
  return (
    <header className="flex h-full w-full items-center justify-center gap-6 z-50">
      <div className="bg-gray-800 text-white w-1/2 h-[56px] lg:h-[72px] rounded-lg bg-gradient-to-tr from-[#ff5001] via-brred to-arblue p-[2px]">
        <div className="container w-full h-full bg-agblack mx-auto py-4 px-4 md:flex md:items-center md:justify-between rounded-lg">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <Image src="https://ik.imagekit.io/xlvg9oc4k/Antigravity/icon.svg?updatedAt=1713111255517" alt="icon" width="45" height="45" />
      ...
      {account.isConnected && (
        <div className="bg-gray-800 text-white w-fit h-[56px] lg:h-[72px] rounded-lg bg-gradient-to-tr from-[#ff5001] via-brred to-arblue p-[2px]">
          {/* <button
              ...
              if (chain && chain.unsupported) {
                ...
                return (
                  <button
                    ...
                    type="button"
                    className="flex container w-full h-full bg-agblack gap-4 items-center px-4 rounded-lg cursor-pointer focus:outline-none"
                  >
                    {chain.hasIcon ? (
                      <img
                        src={chain.iconUrl}
